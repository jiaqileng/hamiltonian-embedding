...
plt.xlabel(r"$N$" + " (number of vertices on the glued trees graph)", fontsize=LABEL_FONT)
plt.xticks(fontsize=TICK_FONT)
plt.yticks(fontsize=TICK_FONT)
#plt.grid()
# plt.show()
plt.savefig(join("resource_estimation_plots", 'glued_trees_resource.png'), dpi=300)