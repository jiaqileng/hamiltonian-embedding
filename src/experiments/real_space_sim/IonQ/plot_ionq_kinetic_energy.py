...
plt.plot(t_vals_high_res, kinetic_energy_analytical_high_res, 's-', markevery=range(num_time_points * plot_every)[::plot_every], color="violet", linewidth=1, label="Closed-form solution for " + r"$\frac{1}{2}\langle\hat{p}\rangle_t$")
...
plt.savefig(join(dirname(__file__), 'real_space_ionq_kinetic_energy.png'), dpi=300)
# plt.show()